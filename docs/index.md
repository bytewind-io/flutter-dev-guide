...
### 🎨 Assets и ресурсы
- **[FL-UI-ICON-IMAGE-FORMAT](rules/dart/FL-UI-ICON-IMAGE-FORMAT.md)** - Рекомендации по использованию иконок и изображений (шрифтовые иконки, WebP, SVG.string)
- **[FL-ASSETS-ICON-DENSITY](rules/dart/FL-ASSETS-ICON-DENSITY.md)** - Растровые иконки с версиями для всех плотностей экрана
